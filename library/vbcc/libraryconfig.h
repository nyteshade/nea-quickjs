...
#define LIBRARY_VERSION_STRING \
    "\0$VER: quickjs." QJS_STR(QJS_VARIANT_NAME) ".library 0.103 (17.4.2026)\r\n"
#define LIBRARY_VERSION_OUTPUT &LIBRARY_VERSION_STRING[7]
#define LIBRARY_VERSION   103  /* packed: major=0, revision=103 (worker stdio isolation — NP_Input/Output=NIL: so AmiSSL in workers doesn't break parent shell redirection) */
