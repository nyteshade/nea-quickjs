 ...
 * JSValue layout matches quickjs.h's non-NAN-boxing form (8 + 8 = 16
 * bytes). Build is compiled with -DJS_NAN_BOXING=0 because VBCC's int64
 * codegen is unreliable; struct-based JSValue avoids the int64 ops in
 * NaN-box construction/extraction. */
struct JSRuntime;
struct JSContext;
typedef union { long int32; double float64; void *ptr; long sbi; } JSValueUnion;
typedef struct { JSValueUnion u; long long tag; } JSValue;
