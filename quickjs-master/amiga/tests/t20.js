/* T20 - T18 but with charCodeAt instead of codePointAt.
 *
 * T18 crashes. The ONLY change here is:
 *   codePointAt(0) -> charCodeAt(0)
 * in is_trailing_surrogate.
 *
 * If this works: codePointAt is broken in event loop context.
 * If this crashes: the surrogate LOOPS are the problem,
 *   not codePointAt specifically.
 *
 * Run: qjs -m amiga/tests/t20.js
 */
...
/* THE CHANGE: charCodeAt instead of codePointAt */
